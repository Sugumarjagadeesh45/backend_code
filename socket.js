...
//       console.log(`     User Location: ${ride.userLocation?.latitude || 'N/A'}, ${ride.userLocation?.longitude || 'N/A'}`);
//     });
//   }
//   console.log("================================\n");
// };
...
//           name: userName,
//           userMobile: userMobile || "N/A",  // Added userMobile to rideData
//           RAID_ID: rideId,
...
//           userName: ride.name, // NEW: User data
//           userMobile: rides[rideId]?.userMobile || ride.userMobile || "N/A", // Prefer memory
...
// // ✅ ADD TO BACKEND socket.js - After ride acceptance

// // -------------------- USER LOCATION UPDATES TO DRIVER --------------------
...
//     // Update in-memory user location if ride exists
//     if (rides[rideId]) {
