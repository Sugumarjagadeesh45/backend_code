...
//         // CRITICAL FIX: Only send user location to the ASSIGNED driver
//         if (rideId && rides[rideId] && rides[rideId].driverId) {
...
//         const availableDrivers = Array.from(activeDriverSockets.values())
//           .filter(driver => driver.isOnline && driver.status !== "onRide");
